        ...
        in  docker.Service::{
            ...
            , environment = Some
                ( toMap
                    ...
                    , NODE_CARDANO_PAYMENT_ADDRESS =
                        options.walletPaymentAddress
            ...
            , depends_on = Some
              [ healthy options.nodeDbHost
              , healthy options.dbSyncDbHost
              , healthy options.walletApiHost
              , docker.mkServiceCondition
